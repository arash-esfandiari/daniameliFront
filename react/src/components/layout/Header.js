                        ...
                        <div className="row">
                            <div className="col-lg-5">
                                <ul className="top-contact text-left">
                                    ...
                                    <li><i className="far fa-envelope" />&nbsp;&nbsp;< a to="mailto:info@example.com.com">info@daniameli.de</ a></li>
                                </ul>
                            </div>
                            ...
                            <div className="container-xl">
                                ...
                                <div className="site-branding ">
                                    <a className="home-link" href={process.env.PUBLIC_URL + '/'} title="Daniameli" rel="home">
                                        <img id="logo-img" className="img-fluid" alt="logo" src="images/logo2.png" />
                                    </a>
                                </div>
                                {/* site-branding end*/}
                                {/*site-navigation */}
